...
> Десктопное приложение на JavaFX с подключением к PostgreSQL.  
> Добавляй, удаляй и храни свои задачи в настоящей базе данных.

![Java](https://img.shields.io/badge/Java-17+-orange?logo=java)
![JavaFX](https://img.shields.io/badge/JavaFX-21-blue?logo=openjfx)
...
Это пет-проект, в котором я использовал:

- 🖥️ **JavaFX** — интерфейс на FXML + CSS
- 🗄️ **PostgreSQL** — работа с БД через JDBC
- 🛠️ **JDBC** — подключение, запросы, транзакции
...
### 🔧 Настройка PostgreSQL (один раз)

1. Установи [PostgreSQL](https://www.postgresql.org/download/)
2. Запусти сервис PostgreSQL
3. Создай пользователя `admin` с паролем `admin`:
...
Скачай последний релиз: [ссылка на релизы]
